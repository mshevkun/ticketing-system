...
export const metadata = {
  title: "Terms of Use - People USA Maintenance Ticketing System",
  description: "Terms of use for the People USA Maintenance Ticketing System",
};
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing or using the People USA Maintenance Ticketing System
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 mt-2">
              ...
              <li>Use the System only for legitimate maintenance requests</li>
              <li>Not submit malicious content, spam, or unauthorized file types</li>
              <li>Respect confidentiality of requests and communications</li>
              <li>Comply with all applicable organizational and facilities policies</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              organization&apos;s maintenance department or People USA administration.
            </p>
          </section>
        </div>

        <p className="mt-10 text-sm text-gray-500">
          © People USA. These terms apply to the Maintenance Ticketing System offered at
          maintenance.people-usa.org.
        </p>
      </div>
    </main>
  );
